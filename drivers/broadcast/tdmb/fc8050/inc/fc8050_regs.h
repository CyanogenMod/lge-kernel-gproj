...
//#define CH0_BUF_LENGTH				(188*16*2)
...
#define CH3_BUF_LENGTH				(128*12)//(128*12*2)
#define CH3_BUF_END 				(CH3_BUF_START + CH3_BUF_LENGTH -1)
#define CH3_BUF_THR 				(CH3_BUF_LENGTH/2-1)

//* check *//
//#if (CH3_BUF_END >= 9728)	// 24ms(use original buffer)
#if (CH3_BUF_END >= 16384)	// > 48ms (use extend buffer)
