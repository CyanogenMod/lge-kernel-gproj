...
#define MSM_ION_MM_SIZE		0x5F00000 //came from g ics for stability issue org : 0x4800000
...
#if defined(CONFIG_MACH_APQ8064_J1D) || defined(CONFIG_MACH_APQ8064_J1KD) || (CONFIG_MACH_APQ8064_L05E)
...
*/
		if (lge_get_uart_mode()) {
			apq8064_device_uart_gsbi4.id = 0;
