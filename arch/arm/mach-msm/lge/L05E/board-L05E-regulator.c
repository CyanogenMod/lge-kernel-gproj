...
VREG_CONSUMERS(L21) = {
	...
	REGULATOR_SUPPLY("touchkey_io",		NULL),
};
VREG_CONSUMERS(L22) = {
...
#if defined(CONFIG_MACH_LGE)
	REGULATOR_SUPPLY("cam1_vio",	"4-000d"), /* GSBI4, Slave Addr: 0x0d, imx091 */
...
#if defined(CONFIG_MACH_LGE) && defined(CONFIG_LGE_BROADCAST_ONESEG)
...
#else
	RPM_LDO(L29, 0, 1, 0, 2700000, 2700000, NULL,          0,     0),
#endif
