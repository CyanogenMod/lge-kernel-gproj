...
static struct acpu_level acpu_freq_tbl_factory_56k_slow[] __initdata = {
...
static struct acpu_level acpu_freq_tbl_factory_56k_nom[] __initdata = {
...
static struct acpu_level acpu_freq_tbl_factory_56k_fast[] __initdata = {
...
#endif
static struct acpu_level acpu_freq_tbl_factory_slow[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   975000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   975000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
...
static struct acpu_level acpu_freq_tbl_factory_nom[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   925000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   950000 },
...
static struct acpu_level acpu_freq_tbl_factory_fast[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   875000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   875000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   900000 },
...
[0][PVS_SLOW]    = { acpu_freq_tbl_factory_56k_slow, sizeof(acpu_freq_tbl_factory_56k_slow),     0 },
[0][PVS_NOMINAL] = { acpu_freq_tbl_factory_56k_nom,  sizeof(acpu_freq_tbl_factory_56k_nom),  25000 },
[0][PVS_FAST]    = { acpu_freq_tbl_factory_56k_fast, sizeof(acpu_freq_tbl_factory_56k_fast), 25000 },
/* TODO: update the faster table when data is available */
[0][PVS_FASTER]  = { acpu_freq_tbl_factory_56k_fast, sizeof(acpu_freq_tbl_factory_56k_fast), 25000 },
...
#endif
static struct pvs_table pvs_tables_factory[NUM_SPEED_BINS][NUM_PVS] __initdata = {
[0][PVS_SLOW]    = { acpu_freq_tbl_factory_slow, sizeof(acpu_freq_tbl_factory_slow),     0 },
[0][PVS_NOMINAL] = { acpu_freq_tbl_factory_nom,  sizeof(acpu_freq_tbl_factory_nom),  25000 },
[0][PVS_FAST]    = { acpu_freq_tbl_factory_fast, sizeof(acpu_freq_tbl_factory_fast), 25000 },
/* TODO: update the faster table when data is available */
[0][PVS_FASTER]  = { acpu_freq_tbl_factory_fast, sizeof(acpu_freq_tbl_factory_fast), 25000 },
...
static int __init acpuclk_8064_probe(struct platform_device *pdev)
{
	...
	|| defined(CONFIG_MACH_APQ8064_GVDCM)
		...
		{
			printk(KERN_INFO"PIF 56K select freq table\n");
			acpuclk_8064_params.pvs_tables = pvs_tables_factory_56k;
		}
		else
#endif
		{
			printk(KERN_INFO"PIF select freq table\n");
			acpuclk_8064_params.pvs_tables = pvs_tables_factory;
		}
	}
#endif
	if (cpu_is_apq8064ab() ||
